...
class TcpConnection extends ConnectionInterface
{
    ...
    public function baseRead($socket, $check_eof = true)
    {
        ...
        if ($this->protocol !== null) {
            ...
            while ($this->_recvBuffer !== '' && !$this->_isPaused) {
                ...
                try {
                    ...
                    call_user_func($this->onMessage, $this, $parser::decode($one_request_buffer, $this), $one_request_buffer);
                } catch (\Exception $e) {
                    Worker::log($e);
                    exit(250);
                } catch (\Error $e) {
        ...
        try {
            call_user_func($this->onMessage, $this, $this->_recvBuffer, $this->_recvBuffer);
        } catch (\Exception $e) {
            Worker::log($e);
            exit(250);
        } catch (\Error $e) {
